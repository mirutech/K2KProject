...
import org.mirkorusso.K2KFURIAC.K2K.KEEL2KNIME;


class KEEL2KNIMEFURIAC implements KEEL2KNIME {
	 ...
	 */
	KEEL2KNIMEFURIAC(String mainDirectory, String resultsFileDirectory, String predictionName, ExecutionContext exec) {
	...
	public Hashtable<Integer, String> modelExtractor(String resultsFileName) throws IOException {
		String resultPath = mainDirectory + resultsFileDirectory + resultsFileName;
		FileReader filereader = new FileReader(resultPath);
	    BufferedReader reader = new BufferedReader(filereader);
	    Hashtable<Integer, String> model = new Hashtable<>();
	    String s = reader.readLine();
	    for(int i = 0; s != null; i++) {
	    	model.put(i, s);
	    	s = reader.readLine();
