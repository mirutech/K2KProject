 ...
 * @author Mirko Russo
 */
public class K2KFURIACNodePlugin extends Plugin {
    // The shared instance.
    private static K2KFURIACNodePlugin plugin;

    /**
     * The constructor.
     */
    public K2KFURIACNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static K2KFURIACNodePlugin getDefault() {
        return plugin;
    }
