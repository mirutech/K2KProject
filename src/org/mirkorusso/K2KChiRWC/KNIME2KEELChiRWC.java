...
class KNIME2KEELChiRWC implements KNIME2KEEL {
	 ...
	 */
	KNIME2KEELChiRWC(String datasetName, String mainDirectory, String dataFilesDirectory, String classColumnName) {
	...
	public void configFileCreator(String algorithmName, String resultFilesDirectory, String[] KEELSettings) 
        ...
        writer.write("outputData = \"" + mainDirectory + resultFilesDirectory + "result.tra\" \"" + mainDirectory + resultFilesDirectory + "result.tst\" \"" + mainDirectory + resultFilesDirectory + "result0.txt\" \"" + mainDirectory + resultFilesDirectory + "result1.txt\"\n\n"); 
