...
class KEEL2KNIMEChiRWC implements KEEL2KNIME {
	 ...
	 */
	KEEL2KNIMEChiRWC(String mainDirectory, String resultsFileDirectory, String predictionName, ExecutionContext exec) {
