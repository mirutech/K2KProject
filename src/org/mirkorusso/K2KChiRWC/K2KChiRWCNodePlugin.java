 ...
 * @author Mirko Russo
 */
public class K2KChiRWCNodePlugin extends Plugin {
    // The shared instance.
    private static K2KChiRWCNodePlugin plugin;

    /**
     * The constructor.
     */
    public K2KChiRWCNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static K2KChiRWCNodePlugin getDefault() {
        return plugin;
    }
